...
/* by a keyword in a tabbed text file     */
/******************************************/
int     read_integer    (FILE *pinF, char *key, int *val){
    static int ns,nc, nb, i;
    static char *string1,*string2,eol[3], *par;
    static char string3[MAX_STR];
    ...
    *val = 0;
    ...
    ns = strlen(key);
    string1 = strstr(par, key);
    if (string1 == NULL){printf("WARNING: subroutine read_integer, keyword not found: %s\n",key); return -1;}
    string1 += ns;
...
/* by a keyword in a tabbed text file     */
/******************************************/
int     read_double     (FILE *pinF, char *key, double *dbl_val){
    static int ns,nc, nb, i;
    static char *string1,*string2,eol[3], *par;
    static char string3[MAX_STR];
